...
#define capGD 100000 //potencia maxima de um GD
...
#define custoGD 80000 //em dolar - gd
...
void AlocacaoGD::ajustePOT(complex<float>S[linha_dados], float P[linha_dados], float P_gd[linha_dados])
{
	for (int k = 1; k < linha_dados; k++)
	{
		if (P_gd[k] != 0)
